...
return array (
  ...
  'summary-second-description' => 'Once we\'ve identified your most popular topic, you\'ll have the chance to develop the specifics.',
  'summary-third-title' => 'VentureFest NE',
  'summary-third-description' => 'We\'ll take your ideas and run with them! The VentureFest programme will be announced early in the autumn!',
  'about-phase-title' => 'An Idea goes through three phases...',
  'phase-first-title' => 'Suggest Topics',
  'phase-first-description' => 'Share your ideas for topics that you think we should focus on during this year\'s People\'s Choice session.',
  'phase-first-detail' => 'Post your suggestions below and vote for topics suggested by others. Please ensure you begin a new idea for each topic you suggest so we can measure the popularity of each. Feel free to discuss ideas with others using the platform and encourage your colleagues and associates to get involved.',
  ...
  'phase-third-description' => 'We\'ll take your ideas and run with them!',
